...
- Migrated service mesh from Consul to Istio with zero downtime
- Led EKS cluster upgrades across multiple environments
- Built CI/CD pipelines serving X+ microservices
- Designed observability stack for production workloads
...
- ✍️ Blog posts coming soon on Dev.to
